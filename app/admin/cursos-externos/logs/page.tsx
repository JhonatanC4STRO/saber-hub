...
export default async function LogsScrapingAdminPage() {
                ...
                {logs.map((log) => (
                  <tr key={log.id} className="hover:bg-[#FAFAFA]">
                    ...
                    <td className="px-4 py-3">
                      <span className={`inline-block px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide ${FUENTE_COLORS[log.fuente] || FUENTE_COLORS.default}`}>
                        {log.fuente}
                      </span>
                    </td>
